...
@section('content')
  ...
  <main class="grid xl:grid-cols-3 xl:p-0 p-4 gap-4">
    ...
    <div class="col-span-2 flex flex-col gap-4">
      ...
      <div class="flex gap-4">
        ...
        <a @class([
          'bg-secondary-200 px-4 py-2 rounded hover:text-white hover-gradient-red-purple',
          'gradient-blue-purple' => $range === 'all'
        ]) href="{{route('expenses', ['range' => 'all'])}}">All</a>
      </div>

      <!-- List and Totals -->
      <div class="grid xl:grid-cols-3 gap-4 h-fit pb-4">
        ...
        <!-- Expenses List -->
        <div class="xl:col-span-3 flex flex-col h-min gap-4">
            ...
            <div class="bg-secondary-200 rounded w-full p-4 flex justify-between items-center">
              ...
              <div>
                <h3>
                  {{$expense['name']}}
                  @if($expense['primary'])
                    <span class="text-base text-green-500">This is a primary expense</span>
                  @endif
                </h3>
    ...
    <!-- Add Expense -->
    <form action="{{route('expense.add')}}" method="POST" class="flex flex-col gap-2 gradient-red-purple p-4 rounded h-fit">
      @csrf
